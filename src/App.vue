<template>
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
              <div class="container">
                  <a class="navbar-brand" href="#page-top">Carsten Höschele</a>
          ...
          <section class="page-section" id="services">
              <div class="container">
                  <div class="text-center">
                      ...
                      <h3 class="section-subheading text-muted">Ich bin ein Software-Entwickler mit einer Leidenschaft für die Erstellung intuitiver, benutzerfreundlicher Web-Erlebnisse. </h3>
                  </div>
